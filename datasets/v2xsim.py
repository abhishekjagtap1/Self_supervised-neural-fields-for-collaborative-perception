...
class V2XSimPixelSource(ScenePixelSource):
...
class V2XSimLiDARSource(SceneLidarSource):
    def __init__(
        self,
...
class V2XSimDataset(SceneDataset):
    ...
    def __init__(
        ...
        assert self.data_cfg.dataset == "v2xsim"
    ...
    def build_data_source(self):
        ...
        if load_pixel:
            pixel_source = V2XSimPixelSource(
        ...
        if self.data_cfg.lidar_source.load_lidar:
            lidar_source = V2XSimLiDARSource(
